(function() {
    ...
    function injectButton(videoTitle) {
        ...
        summaryButton.innerText = '📄 Résumé';
        ...
        summaryButton.addEventListener('mouseover', () => summaryButton.style.backgroundColor = '#0056b3');
        summaryButton.addEventListener('mouseout', () => summaryButton.style.backgroundColor = '#007BFF');
        ...
        summaryPanel.innerHTML = `
            ...
            <h1 style="font-size:24px; border-bottom:2px solid white; padding-bottom:8px; margin-bottom:15px;">Résumé de la vidéo</h1>
            <div id="loading" class="hidden" style="text-align:center; font-weight:bold; font-size:18px;">⏳ Chargement...</div>
            <div id="summary" class="summary-box" style="font-size:18px; line-height:1.6;"></div>
        `;
        ...
        summaryButton.addEventListener('click', () => {
            ...
            .then(data => {
                summaryBox.innerHTML = `<h2 style="font-size:20px; margin-bottom:10px;">Résumé général</h2><p>${data.summary || "Résumé indisponible."}</p>`;

                if (data.chapters && data.chapters.length > 0) {
                    const chaptersContainer = document.createElement('div');
                    chaptersContainer.innerHTML = '<h2 style="font-size:20px; margin-top:20px;">Chapitres</h2>';
